	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("idPasajero")==null && request.getParameter("tipoDoc")==null) {
			...
			Date fechaNacimiento;
				...
				fechaNacimiento = Fechas.getStringAFecha( request.getParameter("fechaNacimiento") );
			...
			Direccion direccion = new Direccion(null, calle, numero, departamento, piso, localidad);
